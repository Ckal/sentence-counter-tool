...
- URL: https://huggingface.co/spaces/Chris4K/sentence-counter-tool
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/sentence-counter-tool/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/sentence-counter-tool
